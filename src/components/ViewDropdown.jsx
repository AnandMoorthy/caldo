            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] text-slate-500 dark:text-slate-400">
                  <kbd className="px-1 py-0.5 rounded bg-slate-200 dark:bg-slate-700 font-mono">{shortcut.split(' / ')[0]}</kbd>
                  <span className="mx-1">/</span>
                  <kbd className="px-1 py-0.5 rounded bg-slate-200 dark:bg-slate-700 font-mono">{shortcut.split(' / ')[1]}</kbd>
                </span>
              </button>
            );
          })}
